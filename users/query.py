...
def login(classcode):
    ...
    if current_user.is_authenticated:  # return true if user is currently logged in
        return True
    elif is_user(classcode):  # return true if email and password match
        login_user(classcode)  # sets flask login_user
        return True
